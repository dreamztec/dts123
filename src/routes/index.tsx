...
function HomePage() {
  return (
    <main className="site-shell">
      ...
      <section className="hero" id="top">
        ...
        <div className="container hero-grid">
          <div className="hero-copy reveal">
            ...
            <p className="hero-kicker">FASTRIDES</p>
            <h1>Your dream destination...<em>on time.</em></h1>
            ...
            <div className="hero-actions">
              ...
              <Link to="/membership" className="button button-ghost">Join FASTRIDES</Link>
            </div>
          ...
          <div className="hero-visual reveal delay-1" aria-label="FASTRIDES ride booking preview">
            <div className="route-card">
              ...
              <div className="ride-options">
                ...
                <div className="ride-option"><Users /><span><strong>FASTRIDES Share</strong><small>Members · max 4</small></span><b>Eligible</b></div>
              </div>
      ...
      <section className="section light-section" id="why-fastrides">
        <div className="container">
          <div className="section-heading split-heading"><div><p className="eyebrow dark"><span /> Why FASTRIDES</p><h2>Not just another ride app.</h2></div><p>You should not have to choose between accessible transportation and professional service. FASTRIDES combines controlled availability, accountable chauffeurs and thoughtful support.</p></div>
      ...
      <section className="section dark-section" id="membership">
        <div className="container">
          <div className="section-heading"><p className="eyebrow"><span /> FASTRIDES membership</p><h2>More than discounts.<br />A better way to move.</h2><p>Priority, predictability and personalised support — configured around how often and how importantly you travel.</p></div>
